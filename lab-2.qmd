...
11. List all of the problems or things you would improve about this graph.
    ...
    The legend title is misleading as legend title states "knowledge level" when the actual data is talking about how much they trust their doctors/nurses. Also, it is hard to tell the difference when the gradient is between light green and dark green.
...
colors <- colorNumeric(palette = "Blues", domain = map_data$percent)

country_map_info |> 
  leaflet() |> 
  addTiles() |> 
  addPolygons(data = country_map_info, 
              color = colors(country_map_info$percent)) |> 
